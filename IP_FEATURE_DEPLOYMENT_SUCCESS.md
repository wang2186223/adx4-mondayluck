...
B列：访问页面      (https://novel.mondayluck.com/novels/...)
C列：用户属性      (Mozilla/5.0 (iPhone; CPU iPhone...))
D列：来源页面      (https://novel.mondayluck.com/...)
...
### 验证步骤：
1. **访问网站**: https://novel.mondayluck.com
2. **浏览任意页面** (首页、小说页、章节页)
...
访问页面: https://novel.mondayluck.com/novels/my-rejected-mate-regrets/chapter-1.html
用户属性: Mozilla/5.0 (iPhone; CPU iPhone OS 16_6 like Mac OS X)
来源页面: https://novel.mondayluck.com/novels/my-rejected-mate-regrets/
