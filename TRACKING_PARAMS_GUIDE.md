...
```
https://novel.mondayluck.com/novels/heartbreak-billionairehe-should-never-have-let-go?fbclid=IwZXh0bgNhZW0...&utm_source=fb&utm_medium=paid
```

但当用户点击"下一章"或其他链接时，这些参数丢失：
```
https://novel.mondayluck.com/novels/heartbreak-billionairehe-should-never-have-let-go/chapter-2
```
...
1. **用户点击 Facebook 广告**
   ```
   原始链接: https://novel.mondayluck.com/novels/novel-name?fbclid=ABC123&utm_source=fb
   ```
...
2. **用户点击新的 Facebook 广告**
   ```
   新链接: https://novel.mondayluck.com/novels/another-novel?fbclid=NEW456&utm_source=fb&utm_campaign=spring2025
   ```
